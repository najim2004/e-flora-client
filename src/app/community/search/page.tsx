        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex gap-2 mb-6">
            <div className="relative flex-1">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-primary/80" />
              <Input
                placeholder="Search posts, users, topics, events..."
                className="pl-10 border-border focus:border-primary/80 focus:ring-primary/80 py-6 text-lg"
                value={searchQuery}
