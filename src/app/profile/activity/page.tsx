...
export default function ActivityHistoryPage() {
  ...
  const activities = [
    {
      ...
      description: "You detected Rice Blast disease in your crop with 85% confidence",
    ...
    },
    {
      ...
      description: "You received personalized crop recommendations for your farm",
    ...
    },
    {
      ...
      description: "You asked about fertilizer recommendations for rice cultivation",
      date: "2023-05-08T09:15:00",
      icon: <MessageSquare className="h-5 w-5 text-blue-500" />,
      details: {
        question: "What is the best fertilizer for rice cultivation?",
        answer: "For optimal rice cultivation, use a balanced NPK fertilizer with a ratio of 4:2:1...",
      },
    },
    {
      id: 4,
    ...
    },
    {
      ...
      description: "You detected Bacterial Leaf Blight in your crop with 78% confidence",
    ...
    },
    {
      ...
      details: {
        ...
        answer: "To control stem borers in rice, you can use integrated pest management approaches including...",
      },
    },
    {
      id: 9,
  ...
  const getActivityTypeBadge = (type: string) => {
    switch (type) {
      ...
      case "account":
        return <Badge className="bg-purple-100 text-purple-700 hover:bg-purple-200">Account</Badge>
      default:
        return <Badge className="bg-gray-100 text-gray-700 hover:bg-gray-200">Other</Badge>
    }
  }
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <div className="flex gap-2">
                    <Select defaultValue="all-time">
                      <SelectTrigger className="w-[180px] border-green-200 focus:border-green-500 focus:ring-green-500">
                    ...
                    <div className="flex flex-wrap gap-3">
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          checked={selectedActivityTypes.includes("disease-detection")}
                          onCheckedChange={(checked) => {
                            if (checked) {
                              setSelectedActivityTypes([...selectedActivityTypes, "disease-detection"])
                            } else {
                              setSelectedActivityTypes(
                                selectedActivityTypes.filter((type) => type !== "disease-detection"),
                              )
                            }
                          }}
                        />
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          id="crop-suggestion"
                          checked={selectedActivityTypes.includes("crop-suggestion")}
                          onCheckedChange={(checked) => {
                            if (checked) {
                              setSelectedActivityTypes([...selectedActivityTypes, "crop-suggestion"])
                            } else {
                              setSelectedActivityTypes(
                                selectedActivityTypes.filter((type) => type !== "crop-suggestion"),
                              )
                            }
                          }}
                        />
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => {
                            if (checked) {
                              setSelectedActivityTypes([...selectedActivityTypes, "chatbot"])
                            } else {
                              setSelectedActivityTypes(selectedActivityTypes.filter((type) => type !== "chatbot"))
                            }
                          }}
                        />
                        <Label
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => {
                            if (checked) {
                              setSelectedActivityTypes([...selectedActivityTypes, "account"])
                            } else {
                              setSelectedActivityTypes(selectedActivityTypes.filter((type) => type !== "account"))
                            }
                          }}
                        />
                        <Label
